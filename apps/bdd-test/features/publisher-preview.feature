...
Feature: Publisher Preview - Not Live
    ...
    Scenario: Publisher should be presented with different streaming control buttons to set configuration
        ...
        Then on the publisher Preview page go live button should be visible
    ...
    Scenario: Publisher should be presented with main video view
        ...
        And on the publisher Preview page video view microphone button should be visible
        And on the publisher Preview page video view microphone button should be enabled
        And on the publisher Preview page video view camera button should be visible
        And on the publisher Preview page video view camera button should be enabled
        And on the publisher Preview page video view source name label value should be "fake_device_0"
        And on the publisher Preview page video view full screen button should be hidden
        And on the publisher Preview page video view should be in normal size
    ...
    Scenario: Publisher should be able to share screen before starting the stream
        ...
        And on the publisher Preview page screen view source name label value should be "screen"
        And on the publisher Preview page screen view full screen button should be hidden
        And on the publisher Preview page screen view stop screen share button should be visible
        And on the publisher Preview page screen view stop screen share button should be enabled
        And on the publisher Preview page screen view should be in normal size

        And on the publisher Preview page video view should be visible
        And on the publisher Preview page video view microphone button should be visible
        And on the publisher Preview page video view microphone button should be enabled
        And on the publisher Preview page video view camera button should be visible
        And on the publisher Preview page video view camera button should be enabled
        ...
        And on the publisher Preview page multi source label should be visible
        And on the publisher Preview page multi source label value should be "Multisource enabled"
   ...
   Scenario: Publisher should be presented with Setting controls
        ...
        Then on the publisher Preview page settings drawer dropdown count should be "5"
    ...
    Scenario: Publisher should be presented with camera selection dropdown under settings
        ...
        # And on the publisher Preview page camera dropdown selected value should be "xxxx"
    ...
    Scenario: Publisher should be presented with microphone selection dropdown under settings
        ...
        # And on the publisher Preview page microphone dropdown selected value should be "xxxx"
    ...
    Scenario: Publisher should be presented with resolution selection dropdown under settings
        ...
        # And on the publisher Preview page resolution dropdown selected value should be "xxxx"
    ...
    Scenario: Publisher should be presented with codec selection dropdown under settings
        ...
        And on the publisher Preview page codec dropdown selected value should be "Codec  - h264"
    ...
    Scenario: Publisher should be presented with bitrate selection dropdown under settings
        ...
        And the publisher clicks on the setting button on the Preview page
        Then on the publisher Preview page settings drawer should be visible
        And on the publisher Preview page bitrate dropdown should be visible
        And on the publisher Preview page bitrate dropdown should be enabled
        And on the publisher Preview page bitrate dropdown selected value should be "Bitrate  - Auto"
        And on the publisher Preview page bitrate dropdown should contain "Auto,2 Mbps,1 Mbps,500 Kbps,250 Kbps" options
    ...
    Scenario: Simulcast should be enabled by default with codec as h264
        ...
        And on the publisher Preview page simulcast input switch should be turned On
        And on the publisher Preview page codec dropdown selected value should be "Codec  - h264"

    Scenario: VP9 codec is available for streaming when simulcast is disabled
        Given a publisher is on the Preview page
        And the publisher clicks on the setting button on the Preview page
        And on the publisher Preview page settings drawer should be visible

        Then the publisher turns Off simulcast input switch on the Preview page
        And on the publisher Preview page simulcast input switch should be turned Off
        And on the publisher Preview page codec dropdown selected value should be "Codec  - h264"
        And on the publisher Preview page codec dropdown should contain "h264,vp8,vp9" options

        Then the publisher turns On simulcast input switch on the Preview page
        And on the publisher Preview page simulcast input switch should be turned On
        And on the publisher Preview page codec dropdown selected value should be "Codec  - h264"
        And on the publisher Preview page codec dropdown should contain "h264,vp8" options
...
#         Then on the publisher Preview page message "Link copied!" should be displayed
    ...
    Scenario: Publisher should be presented with different streaming control buttons after the live stream is stopped
        ...
        And on the publisher Preview page go live button should be visible
        And on the publisher Preview page go live button should be enabled
        And on the publisher Preview page go live button text should be "GO LIVE"
        And on the publisher Preview page add source button should be visible
        And on the publisher Preview page add source button should be enabled
    ...
    Scenario: Publisher should be presented with streaming information after the live stream is stopped
        ...
        And on the publisher Preview page streaming state dot should be hidden
        And on the publisher Preview page multi source label should be hidden
        And on the publisher Preview page company name value should be "Company name"
        And on the publisher Preview page stream time value should be "00:00:00"
        And on the publisher Preview page heading value should be "Get started"
    ...
    Scenario: Publisher should be presented with main video view after the live stream is stopped
        ...
        And on the publisher Preview page screen view should be hidden
    ...
    Scenario: Publisher should be presented with main video view after the live stream is stopped with screen sharing
        Given a publisher is on the Preview page
        ...
        And on the publisher Preview page screen view should be visible
        And on the publisher Preview page screen view source name label value should be "screen"
        And on the publisher Preview page screen view full screen button should be hidden
        And on the publisher Preview page screen view stop screen share button should be visible
        And on the publisher Preview page screen view stop screen share button should be enabled
...
# SC: Verify Settings after streamng is stopped
# SC: Verify seeting  after streamng is stopped when changed during streaming
